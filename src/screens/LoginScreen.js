...
export default function LoginScreen({ navigation }) {
  ...
  const handleLogin = async () => {
    ...
    if (result.length > 0) {
      ...
      showToast(`Welcome back, ${result[0].fullName}! 👋`, "success");
      setTimeout(() => login(result[0]), 800);
    } else {
        ...
        >
          ...
          >
            <Ionicons
              ...
              size={20}
              color={passFocused ? "#7C3AED" : "#9CA3AF"}
              style={styles.inputIcon}
            />
            <TextInput
          ...
          <View style={styles.rememberRow}>
            <View style={styles.switchRow}>
              <Switch
                ...
                thumbColor={remember ? "#7C3AED" : "#f4f3f4"}
                trackColor={{ false: "#374151", true: "#C4B5FD" }}
              />
